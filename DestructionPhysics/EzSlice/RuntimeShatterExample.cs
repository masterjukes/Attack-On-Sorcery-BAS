...
namespace BladeAndTitan.DestructionPhysics.EzSlice
{
    /**
 ...
 */
    public class RuntimeShatterExample : MonoBehaviour {
        ...
        public Plane GetRandomPlane(Vector3 positionOffset, Vector3 scaleOffset) {
            ...
            return new Plane(randomPosition, randomDirection);
        }
